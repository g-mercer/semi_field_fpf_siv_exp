...
See whether a random intercept is required for block/triad?

```{r}
# standardised residuals for M1 vs triad
E_standard <- resid(M1, type = "normalized")

boxplot(E_standard ~ triad, data = sucrose_consumption, axes = TRUE,
        cex.axis=0.75,
        ylab = 'Standardized residuals')
abline(0,0)
```

This indicates triad should be included as a random intercept. 
...
Below shows the small effect on the standardized residuals of including block/triad as a random intercept.
...
boxplot(E7 ~ triad, data = sucrose_consumption, axes = TRUE,
        cex.axis=0.75)
abline(0,0)
