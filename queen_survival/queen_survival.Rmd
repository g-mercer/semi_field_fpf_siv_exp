...
# surv <- Surv(time = queen_surv$queen_survival_days, event = queen_surv$queen_death)
# survdiff(surv ~ queen_surv$treatment)

# risk.table = TRUE,  risk.table.height = 0.25

fit1 <- survfit(Surv(queen_survival_days, queen_death) ~ treatment, data=queen_surv)
