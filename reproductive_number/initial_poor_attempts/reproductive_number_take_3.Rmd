...
theta <- binomial()$linkinv(mean(rstan:::extract(fit4$fit, 'b_zi_Intercept')[[1]])) # not sure if this is quite correct but it will still allow for overdispersion test.
